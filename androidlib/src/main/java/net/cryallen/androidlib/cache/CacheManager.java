package net.cryallen.androidlib.cache;

import android.os.Environment;

import net.cryallen.androidlib.utils.BaseUtils;
...
public class CacheManager {
	...
	/** 缓存文件路径 */
	public static final String APP_CACHE_PATH = Environment.getExternalStorageDirectory().getPath() + "/YiYue/AppData/";
