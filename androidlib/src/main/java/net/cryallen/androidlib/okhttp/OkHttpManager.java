package net.cryallen.androidlib.okhttp;

import net.cryallen.androidlib.okhttp.builder.DeleteBuilder;
import net.cryallen.androidlib.okhttp.builder.DownloadBuilder;
import net.cryallen.androidlib.okhttp.builder.GetBuilder;
import net.cryallen.androidlib.okhttp.builder.PatchBuilder;
import net.cryallen.androidlib.okhttp.builder.PostBuilder;
import net.cryallen.androidlib.okhttp.builder.PutBuilder;
import net.cryallen.androidlib.okhttp.builder.UploadBuilder;
