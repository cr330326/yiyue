package net.cryallen.androidlib.myokhttp;
...
import net.cryallen.androidlib.myokhttp.body.ProgressRequestBody;
import net.cryallen.androidlib.myokhttp.body.ResponseProgressBody;
import net.cryallen.androidlib.myokhttp.response.DownloadResponseHandler;
import net.cryallen.androidlib.myokhttp.response.GsonResponseHandler;
import net.cryallen.androidlib.myokhttp.response.IResponseHandler;
import net.cryallen.androidlib.myokhttp.response.JsonResponseHandler;
import net.cryallen.androidlib.myokhttp.response.StringResponseHandler;
...
public class MyOkHttp {
	...
	private volatile static MyOkHttp instance;
	...
	private class MyCallback implements Callback {
		...
		public void onResponse(Call call, final Response response) throws IOException {
			if(response.isSuccessful()) {
				...
				} else if(mResponseHandler instanceof StringResponseHandler) {     //String字符串回调
					mHandler.post(new Runnable() {
						@Override
						public void run() {
							((StringResponseHandler)mResponseHandler).onSuccess(response.code(), response_body);
						}
					});
				}
			} else {
