package net.cryallen.yiyue.bean.douban.movie;

import net.cryallen.yiyue.bean.douban.movie.child.ImagesBean;
import net.cryallen.yiyue.bean.douban.movie.child.PersonBean;
import net.cryallen.yiyue.bean.douban.movie.child.RatingBean;
...
/***
 * 豆瓣电影详情实体
 Created by chenran on 2018/9/14.
 ***/
