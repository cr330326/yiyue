package net.cryallen.yiyue.presenter.detail;
...
import net.cryallen.androidlib.utils.FileUtils;
import net.cryallen.yiyue.contract.detail.BaseWebViewLoadContract;
...
public abstract class BaseWebViewLoadPresenter<M extends BaseWebViewLoadContract
	...
	protected BaseWebViewLoadContract.IBaseWebViewLoadView mIView = weakRefView.get();
